...
def gameformat():
    ...
    pen.goto(0, 200)
    pen.write("Специална игра", align="center", font=("Arial", 60, "bold"))
    pen.goto(0, 100)
    pen.write("Бутон С", align="center", font=("Arial", 40, "bold"))
    pen.goto(250, -50)
...
def buttonCcolor():
    pen.color("red")
    pen.goto(0, 100)
    pen.write("Бутон C", align="center", font=("Arial", 40, "bold"))
    pen.color("white")
    sleep(0.5)
    pen.clear()
